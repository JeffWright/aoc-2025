...
fun generateStatus() {
  ...
  val readme = buildString {
    ...
    appendLine()
    appendLine("![](https://img.shields.io/badge/⭐_Stars-${metrics.total_stars}/${NUM_DAYS*2}-brightgreen)")
    appendLine()
    appendLine("## Runtimes")
    appendLine()
    ...
    (1..NUM_DAYS).forEach { day ->
      ...
      val part1Badge = dayMetrics?.part1?.let {
      ...
      val part2Badge = dayMetrics?.part2?.let {
